...
const potd = () => {
    ...
    return (
        ...
        >
            <TouchableOpacity style={{ width: windowWidth, height: 140, flex: 1, display: 'flex', alignItems: 'center', marginBottom: 20, position: 'relative' }}>
                ...
                />
                <Text style={{ position: 'absolute', right: 20, bottom: 20, zIndex: 100, fontSize: 20, color: '#A7A7A8' }}>Picture of The Day</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ width: windowWidth, height: 140, flex: 1, display: 'flex', alignItems: 'center', marginBottom: 20, position: 'relative' }}>
            <LinearGradient colors={['transparent', '#000000']} useAngle={true} angle={170} angleCenter={{x:0.5,y:0.5}} style={{ position: 'absolute', height: '100%', width: '100%', zIndex: 10 , borderRadius: 15}}></LinearGradient>
                <Image
                    ...
                    source={{ uri: `${data.url}` }}
                />
                <Text style={{ position: 'absolute', right: 20, bottom: 20, zIndex: 100, fontSize: 20, color: '#A7A7A8' }}>Mars Today</Text>
            </TouchableOpacity>
        </View>
